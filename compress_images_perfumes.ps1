...
$publicDir = "c:\Users\Randerson\.gemini\antigravity\scratch\site-perfumes\public"
$blogDir = "c:\Users\Randerson\.gemini\antigravity\scratch\site-perfumes\src\content\blog"
